...
def plot_circle(circle):
    ...
    plt.gca().add_patch(
        plt.Circle(
            (circle.C.x, circle.C.y), circle.r - 0.2, edgecolor="lightgreen", facecolor="lightgreen"
        )
    )
...
def particle_swarm_optimization(
    ...
    for iteration_i in range(max_iterations):
        if iteration_i % 20 == 0:
            print("%i th iteration" % int(iteration_i))
            print_iteration += 1
...
def main():
    print("Please wait:")
    # step_sizes=np.arange(1, 100, 1)
    # elapsed_times = []
    # for step_size in step_sizes:
    start_time = time.time()
    best_location = []  # for the plot

    obstacle1 = ob.Obstacle_Circle(3, ob.Point(9, 14))
    obstacle2 = ob.Obstacle_Circle(1.5, ob.Point(8  , 6))
    obstacle3 = ob.Obstacle_Circle(2, ob.Point(11.5, 9))
    obstacle4 = ob.Obstacle_Circle(1, ob.Point(4, 3))
    obstacle5 = ob.Obstacle_Circle(2.5, ob.Point(3, 11))
    obstacle6 = ob.Obstacle_Circle(1.5, ob.Point(5, 7.5))
    obstacle7 = ob.Obstacle_Circle(1, ob.Point(2, 18))
    obstacle8 = ob.Obstacle_Circle(2, ob.Point(15, 2.5))
    ...
    print(f"100% completed! Time taken: {elapsed_time:.2f} seconds")
    
    # print("Elapsed times for different swarm sizes:")
    # print(elapsed_times)
