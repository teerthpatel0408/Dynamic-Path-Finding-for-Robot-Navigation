...
def get_circle(x, y):
    return (x * TILE + TILE // 2, y * TILE + TILE // 2), TILE // 5
...
bg = pg.image.load('C:/Users/Ayush Patel/OneDrive/Desktop/.vs/Python-Dijkstra-BFS-A-star-master/Python-Dijkstra-BFS-A-star-master/Python-Dijkstra-BFS-A-star-master/img/3.png').convert()
...
while True:
    ...
    sc.blit(bg, (0, 0))
    # draw BFS work
    [pg.draw.rect(sc, pg.Color('white'), get_rect(x, y), 1) for x, y in visited]
